...
* `GENESYS_SCALER\VID_03F0&PID_0610&MSTAR_TSUM_G&PANELREV_EIM121` (quirk-only, as it changes
  with every release)
...
Enumeration and an update from EIM121 to EIM162 have been tested on the EIM1 variant.
